...
namespace Core.Migrations
{
    ...
    [Migration("20200203185547_NullableTypeVkAudio")]
    partial class NullableTypeVkAudio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entity.VkAudio", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Entity.VkAudioArtist", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("VkAudioArtist");
                });

            modelBuilder.Entity("Core.Entity.VkAudioToArtist", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("VkAudioArtistsId")
                        .HasColumnType("bigint");

                    b.Property<long>("VkAudioId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("VkAudioArtistsId");

                    b.HasIndex("VkAudioId");

                    b.ToTable("VkAudioToArtist");
                });

            modelBuilder.Entity("Core.Entity.VkAudioToUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Entity.VkAudioToArtist", b =>
                {
                    b.HasOne("Core.Entity.VkAudioArtist", "VkAudioArtist")
                        .WithMany()
                        .HasForeignKey("VkAudioArtistsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entity.VkAudio", "VkAudio")
                        .WithMany()
                        .HasForeignKey("VkAudioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
